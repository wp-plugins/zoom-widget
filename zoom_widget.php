...
{
	?>
<img src="<?php echo plugins_url('elements/',__FILE__); ?>images/<?php echo  $img_group_id; ?>/<?php echo  $a[$i]; ?>.png" id="<?php echo  $a[$i]; ?>" style="display:<?php if($but_pos) echo "inline"; else echo "block"; ?>;cursor:pointer; height:<?php echo  $size[$a[$i]]; ?>px" onclick="<?php echo  $func[$a[$i]]; ?> "/>
	<?php
